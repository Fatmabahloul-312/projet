...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="nom" value="{{$preparatrices->nom}}" id="formGroupExampleInput" placeholder="">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Prénom</label>
  <input type="text" class="form-control" name="prenom" value="{{$preparatrices->prenom}}" id="formGroupExampleInput2" placeholder="">
</div>
<div  class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control"name="email" value="{{$preparatrices->email}}" id="exampleInputEmail1" aria-describedby="emailHelp"> 
  </div>
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="telephone" value="{{$preparatrices->telephone}}" id="formGroupExampleInput2" placeholder="">
</div>
