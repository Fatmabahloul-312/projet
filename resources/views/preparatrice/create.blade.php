...
<form action="{{route('preparatrice.store')}}" method="POST" enctype="multipart/form-data">
...
<div  class="mb-3">
  ...
  <div  class="mb-3">
    ...
    <br>
    &nbsp; &nbsp; &nbsp; &nbsp; <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="detail" id="inlineCheckbox3" value="disponible">
      <label class="form-check-label" for="inlineCheckbox3">disponible</label>
    </div>
  <div class="form-check form-check-inline">
    <input class="form-check-input" type="checkbox" name="detail" id="inlineCheckbox4" value=" non disponible">
    <label class="form-check-label" for="inlineCheckbox4">non disponible</label>
  </div>
  </div>
<div class="mb-3">
  ...
  <a class="btn btn-info " target="__blank" href="{{ route('preparatrice.index')}}">Retour</a>
  </div>
</form>
</div>
